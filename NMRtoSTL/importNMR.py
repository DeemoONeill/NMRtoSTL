...
class importNMR:
    ...
    def read_file(self, verbose=False):
        ...
        import_functions = [self.read_Bruker_proc, 
                            self.read_pipe
                            #self.read_Varian
                           ]
        ...
        if self.udic[0]['freq'] == False or self.udic[1]['freq'] == False:
            raise ValueError("Data must be frequency domain! "
                             "Perform a Fourier transform before processing.")
        
        
        
    def make_scales(self, verbose=False, 
                    f1_min=None, f1_max=None, f2_min=None, f2_max=None):
        """
        ...
        self.data = self.data[limits_pts[0]:limits_pts[1], 
                              limits_pts[2]:limits_pts[3]]
